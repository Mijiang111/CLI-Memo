...
export function renderResumeMarkdown({ recovery }) {
  ...
  return [
    ...
    "",
    "1. Read `.project-agent/agent-context-bundle.json`.",
    "2. Read `.project-agent/governance-spec.json`.",
    "3. Read `.project-agent/continuity-contract.json`.",
    "4. Read `.project-agent/agent-runbook.json`.",
    "5. Read `.project-agent/memory-graph.json`.",
    "6. Read `.project-agent/process-trace.json`.",
    "7. Read `.project-agent/development-trail.json`.",
    "8. Read `.project-agent/architecture-map.json`.",
    "9. Read `.project-agent/state-manifest.json`.",
    "10. Read `.project-agent/takeover-packet.json`.",
    "11. Read `.project-agent/continuity.json`.",
    "12. Read this file: `.project-agent/resume.md`.",
    "13. Read `.project-agent/recovery.md` for the full recovery brief.",
    "14. Inspect changed files before editing.",
    "15. Continue from the current cursor; record new events before and after tool calls.",
    "",
    "## Current Objective",
    "",
