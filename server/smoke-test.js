...
try {
  ...
  if (!contextPromptMarkdown.includes("Bundle-Only Next Agent Starter Prompt") || !contextPromptMarkdown.includes("## Bundle Gate") || !contextPromptMarkdown.includes("## Attention Pack") || !contextPromptMarkdown.includes("## Freshness Gate") || !contextPromptMarkdown.includes("## Runtime Eval") || !contextPromptMarkdown.includes("## Phase Ledger") || !contextPromptMarkdown.includes("## Checkpoint Ledger") || !contextPromptMarkdown.includes("## Decision Ledger") || !contextPromptMarkdown.includes("## State Boundary") || !contextPromptMarkdown.includes("## Code Graph") || !contextPromptMarkdown.includes("## Hook Ingress") || !contextPromptMarkdown.includes("## Provenance Ledger") || !contextPromptMarkdown.includes("## Disclosure Gate") || !contextPromptMarkdown.includes("## Pre-Edit Risk") || !contextPromptMarkdown.includes("## Handoff Lifecycle") || !contextPromptMarkdown.includes("## Objective Coverage") || !contextPromptMarkdown.includes("## Takeover Acceptance") || !contextPromptMarkdown.includes("## Memory Snapshot") || !contextPromptMarkdown.includes("Development trail:") || !contextPromptMarkdown.includes("## Architecture Snapshot")) {
  ...
  if (!nextAgentPromptFile.includes("Mandatory Read Order") || !nextAgentPromptFile.includes("Required First Actions") || !nextAgentPromptFile.includes("## Attention Pack") || !nextAgentPromptFile.includes("## Freshness Gate") || !nextAgentPromptFile.includes("## Runtime Eval") || !nextAgentPromptFile.includes("## Phase Ledger") || !nextAgentPromptFile.includes("## Decision Ledger") || !nextAgentPromptFile.includes("## State Boundary") || !nextAgentPromptFile.includes("## Code Graph") || !nextAgentPromptFile.includes("## Hook Ingress") || !nextAgentPromptFile.includes("## Provenance Ledger") || !nextAgentPromptFile.includes("## Disclosure Gate") || !nextAgentPromptFile.includes("## Pre-Edit Risk") || !nextAgentPromptFile.includes("## Handoff Lifecycle") || !nextAgentPromptFile.includes(".project-agent/governance-spec.json") || !nextAgentPromptFile.includes(".project-agent/state-manifest.json")) {
