...
try {
  ...
  if (contextBundleEndpoint.agentContextBundle?.schemaVersion !== "project-agent.context-bundle.v1" || !contextBundleEndpoint.agentContextBundle?.contentHash || !contextBundleEndpoint.agentContextBundle?.memory?.graph?.nodes?.length || !contextBundleEndpoint.agentContextBundle?.process?.trace?.current || !contextBundleEndpoint.agentContextBundle?.architecture?.map?.tree?.length || !contextBundleEndpoint.agentContextBundle?.validation?.stateManifestVerification?.ok || contextBundleEndpoint.agentContextBundle?.validation?.disclosureGate?.schemaVersion !== "project-agent.disclosure-gate.v1" || contextBundleEndpoint.agentContextBundle?.validation?.freshnessGate?.schemaVersion !== "project-agent.freshness-gate.v1" || contextBundleEndpoint.agentContextBundle?.validation?.phaseLedger?.schemaVersion !== "project-agent.phase-ledger.v1" || contextBundleEndpoint.agentContextBundle?.validation?.checkpointLedger?.schemaVersion !== "project-agent.checkpoint-ledger.v1" || contextBundleEndpoint.agentContextBundle?.validation?.decisionLedger?.schemaVersion !== "project-agent.decision-ledger.v1" || contextBundleEndpoint.agentContextBundle?.validation?.runtimeEval?.schemaVersion !== "project-agent.runtime-eval.v1" || contextBundleEndpoint.agentContextBundle?.validation?.hookIngressAudit?.schemaVersion !== "project-agent.hook-ingress-audit.v1" || contextBundleEndpoint.agentContextBundle?.validation?.provenanceLedger?.schemaVersion !== "project-agent.provenance-ledger.v1" || contextBundleEndpoint.agentContextBundle?.validation?.attentionPack?.schemaVersion !== "project-agent.attention-pack.v1" || !contextBundleEndpoint.agentContextBundle?.validation?.attentionPack?.items?.length || contextBundleEndpoint.agentContextBundle?.validation?.preEditRisk?.schemaVersion !== "project-agent.pre-edit-risk.v1" || contextBundleEndpoint.agentContextBundle?.handoff?.lifecycle?.schemaVersion !== "project-agent.handoff-lifecycle.v1") {
  ...
  if (!contextPromptMarkdown.includes("Bundle-Only Next Agent Starter Prompt") || !contextPromptMarkdown.includes("## Bundle Gate") || !contextPromptMarkdown.includes("## Attention Pack") || !contextPromptMarkdown.includes("## Freshness Gate") || !contextPromptMarkdown.includes("## Runtime Eval") || !contextPromptMarkdown.includes("## Phase Ledger") || !contextPromptMarkdown.includes("## Checkpoint Ledger") || !contextPromptMarkdown.includes("## Decision Ledger") || !contextPromptMarkdown.includes("## Code Graph") || !contextPromptMarkdown.includes("## Hook Ingress") || !contextPromptMarkdown.includes("## Provenance Ledger") || !contextPromptMarkdown.includes("## Disclosure Gate") || !contextPromptMarkdown.includes("## Pre-Edit Risk") || !contextPromptMarkdown.includes("## Handoff Lifecycle") || !contextPromptMarkdown.includes("## Objective Coverage") || !contextPromptMarkdown.includes("## Takeover Acceptance") || !contextPromptMarkdown.includes("## Memory Snapshot") || !contextPromptMarkdown.includes("Development trail:") || !contextPromptMarkdown.includes("## Architecture Snapshot")) {
  ...
  if (!nextAgentPromptFile.includes("Mandatory Read Order") || !nextAgentPromptFile.includes("Required First Actions") || !nextAgentPromptFile.includes("## Attention Pack") || !nextAgentPromptFile.includes("## Freshness Gate") || !nextAgentPromptFile.includes("## Runtime Eval") || !nextAgentPromptFile.includes("## Phase Ledger") || !nextAgentPromptFile.includes("## Decision Ledger") || !nextAgentPromptFile.includes("## Code Graph") || !nextAgentPromptFile.includes("## Hook Ingress") || !nextAgentPromptFile.includes("## Provenance Ledger") || !nextAgentPromptFile.includes("## Disclosure Gate") || !nextAgentPromptFile.includes("## Pre-Edit Risk") || !nextAgentPromptFile.includes("## Handoff Lifecycle") || !nextAgentPromptFile.includes(".project-agent/governance-spec.json") || !nextAgentPromptFile.includes(".project-agent/state-manifest.json")) {
